...
например, трансформация значений к lowerCase в DTO,
делал на скорую руку, так как у меня еще 4 тестовых на очереди.
Прошу сделать скидку на то, что это тестовое задание :)
