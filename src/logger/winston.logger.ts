...
import { createLogger as createWinston, Logger, LoggerOptions } from 'winston';
...
export const createWinstonLogger = (opts: LoggerOptions) =>
  new WinstonLogger(createWinston(opts));
